...
const FontFileDownloader = () => {
  ...
  return (
    <section className="container mx-auto px-4 py-10">
      <h1 className="text-center text-xl font-medium mb-8">Font File Downloader</h1>
      <div>
        <div className="grid w-full max-w-sm mx-auto items-center gap-1.5">
          <Label htmlFor="font-css-file-link">Font CSS File Link</Label>
          <Input
            value={cssUrl}
          ...
          <div className="flex justify-end">
            <Button
              className="mt-5"
              disabled={loading || (cssUrl === '' && fontSrcPrefix === '')}
              variant="link"
              onClick={() => {
                setCssUrl('');
                setFontSrcPrefix('');
          ...
          <Button onClick={onClickProcessAndDownload} disabled={cssUrl === '' || loading} className="mt-5">
